...
import './Me.css'
import uni_logo from './assets/images/gcwuf.png'
        ...
        <div class="container py-4">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Faisalabad, Pakistan</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+92300 123 4567</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>lms@gmail.com</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-4 text-center text-md-start mb-3 mb-md-0">
                        &copy;2023  <Link class="border-bottom" to="/"> CODE HUB</Link><br/><br/>
                        All Right are Reserved
                    </div>
                    <div class="col-md-4 text-center text-md-start mb-3 mb-md-0">
                        <img class="uni_log" src={uni_logo}/>
                    </div>
